...
public class DemoLayoutAlignView extends ModulesView {
    public DemoLayoutAlignView(Context context) {
        super(context);
        init();
    }
    ...
    private void init() {
        ...
        mTextModule2.setText("AlignLeft to [ViewCenter]");
        ...
        mTextModule3.setText("AlignTop to [ViewCenter]");
        ...
        mTextModule3.getLayoutParams()
                .setGravity(GravityCompat.CENTER)
                .setAlignTop(mTextModule1)
                .setDimensions(dp(60), LayoutParams.WRAP_CONTENT);


        mTextModule4 = new TextModule(mContext);
        mTextModule4.setText("AlignRight to [ViewCenter]");
        ...
        mTextModule4.getLayoutParams()
                .setGravity(GravityCompat.CENTER)
                .setAlignRight(mTextModule1)
                .setDimensions(dp(60), LayoutParams.WRAP_CONTENT);

        mTextModule5 = new TextModule(mContext);
        mTextModule5.setText("AlignBottom to [ViewCenter]");
